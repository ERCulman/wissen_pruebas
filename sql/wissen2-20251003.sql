...
INSERT INTO `asignacion_acudiente` VALUES (6,2,2,'Padre','Si','Si',NULL,''),(7,3,14,'Madre','Si','Si',NULL,'');
...
CREATE TABLE `asistencia_clase` (
  ...
  `matricula_id` int NOT NULL,
  `fecha` date NOT NULL,
  `hora_inicio_clase` time NOT NULL COMMENT 'Hora de inicio de la clase',
  `hora_fin_clase` time NOT NULL COMMENT 'Hora de finalización de la clase',
  ...
  KEY `idx_horario_clase` (`fecha`,`hora_inicio_clase`,`hora_fin_clase`),
...
INSERT INTO `asistencia_clase` VALUES (8,55,3,'2025-10-03','07:00:00','08:00:00','Ausente',0,'Sin justificar',NULL,27,'2025-10-04 01:46:59'),(10,57,3,'2025-10-03','07:00:00','08:00:00','Presente',0,'No aplica',NULL,27,'2025-10-04 02:04:46');
...
INSERT INTO `cuerpo_docente` VALUES (1,15,NULL,30,'','2025-09-30 23:57:02','2025-10-01 01:18:42'),(2,13,NULL,20,'','2025-10-01 14:19:11','2025-10-01 14:23:33'),(3,12,NULL,25,'','2025-10-01 14:19:26','2025-10-01 14:19:26');
...
INSERT INTO `curso` VALUES (1,'Númerico','01'),(6,'Númerico','02');
...
INSERT INTO `docente_asignaturas_habilitadas` VALUES (3,1,4),(9,1,10),(10,2,11),(11,2,12),(12,3,11);
...
CREATE TABLE `grupo` (
  ...
  `cupos` int NOT NULL,
  `tipo` enum('Regular','Multigrado') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Regular',
  `grupo_padre_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `oferta_educativa_id` (`oferta_educativa_id`),
  KEY `curso_id` (`curso_id`),
  KEY `fk_grupo_padre_idx` (`grupo_padre_id`),
...
INSERT INTO `grupo` VALUES (8,18,1,'Segundo 001 - 25 Cupos',25,'Regular',NULL),(12,19,1,'Segundo 001 - 25 Cupos',25,'Regular',NULL),(22,18,6,'Segundo 02 - 10 Cupos',10,'Regular',NULL),(23,22,1,'Primero 001 - 25 Cupos',25,'Regular',NULL),(24,23,1,'Tercero 001 - 20 Cupos',20,'Regular',NULL),(25,23,6,'Tercero 02',20,'Regular',NULL);
...
CREATE TABLE `justificaciones_asistencia` (
  ...
  `tipo_documento` enum('Incapacidad médica','Excusa familiar','Calamidad doméstica','Otro') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `descripcion` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `nombre_archivo_original` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `nombre_archivo_sistema` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'UUID del archivo en el sistema',
  ...
  `observaciones_docente` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
...
--
-- Dumping data for table `justificaciones_asistencia`
--

LOCK TABLES `justificaciones_asistencia` WRITE;
/*!40000 ALTER TABLE `justificaciones_asistencia` DISABLE KEYS */;
/*!40000 ALTER TABLE `justificaciones_asistencia` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `matricula` VALUES (2,1,12,4,'2025-1-0002','2025-02-10','Si','Si','Matriculado'),(3,7,8,1,'2025-01-0003','2025-02-25','Si','No','Matriculado');
...
INSERT INTO `permisos_especiales` VALUES (16,32,4),(38,37,1),(38,92,1),(38,155,1),(38,156,1),(38,157,1),(38,158,1);
...
INSERT INTO `roles_institucionales` VALUES (1,10,8,2,'2025-02-10',NULL,'Activo'),(2,29,7,2,'2025-02-10',NULL,'Activo'),(3,14,3,1,'2025-09-27',NULL,'Activo'),(5,17,8,1,'2025-09-27',NULL,'Activo'),(6,19,8,1,'2025-09-27',NULL,'Activo'),(7,21,8,1,'2025-09-27',NULL,'Activo'),(8,31,8,2,'2025-09-27',NULL,'Activo'),(9,34,8,2,'2025-09-27',NULL,'Activo'),(10,29,6,1,'2025-09-27',NULL,'Activo'),(11,38,7,1,'2025-09-27',NULL,'Activo'),(12,16,5,2,'2025-09-27',NULL,'Activo'),(13,22,5,2,'2025-09-27',NULL,'Activo'),(14,16,7,1,'2025-09-27',NULL,'Activo'),(15,27,5,1,'2025-09-30',NULL,'Activo'),(16,38,3,2,'2025-10-01',NULL,'Activo'),(17,38,7,2,'2025-10-02',NULL,'Activo');
...
-- Dump completed on 2025-10-03 21:21:09
