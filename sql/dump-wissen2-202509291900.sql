...
CREATE TABLE `docente_asignaturas_habilitadas` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_docente_asignatura` (`cuerpo_docente_id`,`asignatura_id`),
  KEY `fk_habilitadas_asignatura` (`asignatura_id`),
  CONSTRAINT `fk_habilitadas_asignatura` FOREIGN KEY (`asignatura_id`) REFERENCES `asignatura` (`id`) ON DELETE CASCADE,
...
INSERT INTO `permisos_especiales` VALUES (16,32,4);
...
-- Dump completed on 2025-09-29 19:00:34
