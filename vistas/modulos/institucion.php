              ...
              <div class="box-body" id="camposEditar">
                  ...
                  <div class="form-row">
                      <div class="form-group col-md-6">
                          <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-user-plus"></i></span>
                              <select type="text" class="form-control input-lg" name="editarEstadoInstitucion" id="editarEstadoInstitucion">
                                  <option value="">Seleccione...</option>
                                  <option value="1">Activo</option>
                                  <option value="0">Inactivo</option>
                              </select>
                              ...
                              <div class="col-md-12">
                                  <table style="border: none; width: 100%;">
                                      <tr style="border: none;">
                                          <td style="border: none; padding: 10px; font-weight: bold; width: 40%;">Nombre de la Institución:</td>
                                          <td style="border: none; padding: 10px;" id="verNombreInstitucion"></td>
                                      </tr>
                                      <tr style="border: none;">
                                          <td style="border: none; padding: 10px; font-weight: bold;">Código DANE:</td>
                                          <td style="border: none; padding: 10px;" id="verCodigoDane"></td>
                                      </tr>
                                      <tr style="border: none;">
                                          <td style="border: none; padding: 10px; font-weight: bold;">NIT:</td>
                                          <td style="border: none; padding: 10px;" id="verNIT"></td>
                                      </tr>
                                      <tr style="border: none;">
                                          <td style="border: none; padding: 10px; font-weight: bold;">Resolución de Creación:</td>
                                          <td style="border: none; padding: 10px;" id="verResolucionCreacion"></td>
                                      </tr>
                                      <tr style="border: none;">
                                          <td style="border: none; padding: 10px; font-weight: bold;">Dirección:</td>
                                          <td style="border: none; padding: 10px;" id="verDireccion"></td>
                                      </tr>
                                      <tr style="border: none;">
                                          <td style="border: none; padding: 10px; font-weight: bold;">Email:</td>
                                          <td style="border: none; padding: 10px;" id="verEmail"></td>
                                      </tr>
                                      <tr style="border: none;">
                                          <td style="border: none; padding: 10px; font-weight: bold;">Teléfono:</td>
                                          <td style="border: none; padding: 10px;" id="verTelefono"></td>
                                      </tr>
                                      <tr style="border: none;">
                                          <td style="border: none; padding: 10px; font-weight: bold;">Cantidad de Sedes:</td>
                                          <td style="border: none; padding: 10px;" id="verCantidadSedes"></td>
                                      </tr>
                                      <tr style="border: none;">
                                          <td style="border: none; padding: 10px; font-weight: bold;">Representante:</td>
                                          <td style="border: none; padding: 10px;" id="verUsuarioRepresentante"></td>
                                      </tr>
                                      <tr style="border: none;">
                                          <td style="border: none; padding: 10px; font-weight: bold;">Estado:</td>
                                          <td style="border: none; padding: 10px;" id="verEstadoInstitucion"></td>
                                      </tr>
                                  </table>
                              </div>
                          </div>
