                        ...
                        if(!empty($datosAgrupados)) {
                            ...
                            foreach ($datosAgrupados as $key => $value) {
                                ...
                                if(!empty($value["grupos"])) {
                                    ...
                                    // Si no hay grupos, mostrar fila vacía
                                    echo '<tr>';

                                    if($mostrarAnio) {
                                        echo '<td style="vertical-align: middle; text-align: center;">'.$value["anio"].'</td>';
                                    }
                                    if($mostrarSede) {
                                        echo '<td style="vertical-align: middle;">'.$value["nombre_sede"].'</td>';
                                    }
                                    if($mostrarJornada) {
                                        echo '<td style="vertical-align: middle; text-align: center;">'.$value["nombre_jornada"].'</td>';
                                    }
                                    if($mostrarNivel) {
                                        echo '<td style="vertical-align: middle;">'.$value["nombre_nivel"].'</td>';
                                    }
                                    if($mostrarGrado) {
                                        echo '<td style="vertical-align: middle; text-align: center;">'.$value["nombre_grado"].'</td>';
                                    }

                                    echo '<td><em>Sin grupos asignados</em></td>';
                                    echo '<td style="text-align: center;"><em>N/A</em></td>';
                                    echo '</tr>';
                                }
...
<?php
$editarOfertaEducativa = new ControladorOfertaEducativa();
$editarOfertaEducativa -> ctrEditarOfertaEducativa();
?>
</form>
</div>
</div>
...
<!-- =======================================
  MODAL VER OFERTA EDUCATIVA
=======================================-->

<div id="modalVerOfertaEducativa" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="formVerOfertaEducativa">
                <div class="modal-header" style="background: #3c8ebdff; color: white;">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title"><i class="fa fa-search"></i> Ver Oferta Educativa</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <table style="border: none; width: 100%;">
                                ...
                                <tr style="border: none;">
                                    <td style="border: none; padding: 10px; font-weight: bold;">Sede:</td>
                                    <td style="border: none; padding: 10px;" id="verSedeOferta"></td>
                                </tr>
                                <tr style="border: none;">
                                    <td style="border: none; padding: 10px; font-weight: bold;">Jornada:</td>
                                    <td style="border: none; padding: 10px;" id="verJornadaOferta"></td>
                                </tr>
                                <tr style="border: none;">
                                    <td style="border: none; padding: 10px; font-weight: bold;">Nivel Educativo:</td>
                                    <td style="border: none; padding: 10px;" id="verNivelEducativo"></td>
                                </tr>
                                <tr style="border: none;">
                                    <td style="border: none; padding: 10px; font-weight: bold;">Grado:</td>
                                    <td style="border: none; padding: 10px;" id="verGradoOferta"></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary btnEditarOfertaEducativa" data-dismiss="modal">
                        <i class="fa fa-edit"></i> Editar
                    </button>
                    <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Salir</button>
                </div>
